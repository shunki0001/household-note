...
//         customErrors.name = '名前を入力して下さい(Vue)';
//         isValid = false;
//     }

//     // メールアドレスのバリデーション
//     if (!form.email || form.email.toString().trim() === '') {
//         customErrors.email = 'メールアドレスを入力して下さい(Vue)';
//         isValid = false;
//     } else {
//         // メールアドレスの形式チェック
//         const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
//         if (!emailRegex.test(form.email)) {
//             customErrors.email = '正しいメールアドレスの形式で入力して下さい(Vue)';
//             isValid = false;
//         }
//     }
...
//         customErrors.password = 'パスワードを入力して下さい(Vue)';
//         isValid = false;
//     } else if (form.password.length < 8) {
//         customErrors.password = 'パスワードは8文字以上で入力して下さい(Vue)';
//         isValid = false;
//     }

//     // パスワード確認のバリデーション
//     if (!form.password_confirmation || form.password_confirmation.toString().trim() === '') {
//         customErrors.password_confirmation = 'パスワード確認を入力して下さい(Vue)';
//         isValid = false;
//     } else if (form.password !== form.password_confirmation) {
//         customErrors.password_confirmation = 'パスワードが一致しません(Vue)';
//         isValid = false;
//     }
