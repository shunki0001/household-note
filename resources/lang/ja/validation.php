...
return [
    ...
    'custom' => [
        ...
        'amount' => [
            'required' => '金額を入力して下さい。',
            'numeric' => '金額は数値で入力して下さい。',
            'min' => '金額は0以上の値を入力して下さい。',
        ],
        'date' => [
            'required' => '日付を入力して下さい。',
            'date' => '日付はYYYY-MM-DDの形式で入力して下さい。',
        ],
        'title' => [
            'required' => '費用名を入力して下さい。',
            'max' => '費用名は255文字以内で入力して下さい。',
        ],
        'category_id' => [
        ...
        'income_date_id' => [
            'required' => 'カテゴリーを入力して下さい。',
            'exists' => 'カテゴリーが存在しましせん。',
        ],
        'income_category_id' => [
            'required' => 'カテゴリーを選択して下さい。',
            'exists' => 'カテゴリーが存在しません',
