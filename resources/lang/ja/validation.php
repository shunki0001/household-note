...
return [
    ...
    'custom' => [
        ...
        'email' => [
            'required' => 'メールアドレスを入力して下さい。(バックエンドから出力)',
            'email'    => '正しいメールアドレス形式で入力して下さい。(バックエンドから出力)',
            'unique'   => 'このメールアドレスは使用できません。',
        ],
        'name' => [
            'required' => '名前を入力して下さい。(バックエンドから出力)',
        ],
        'amount' => [
            'required' => '金額を入力して下さい。(バックエンドから出力)',
            'numeric' => '金額は数値で入力して下さい。(バックエンドから出力)',
            'min' => '金額は0以上の値を入力して下さい。(バックエンドから出力)',
        ],
        'date' => [
            'required' => '日付を入力して下さい。(バックエンドから出力)',
            'date' => '日付はYYYY-MM-DDの形式で入力して下さい。(バックエンドから出力',
        ],
        'title' => [
            'required' => '費用名を入力して下さい。(バックエンドから出力)',
            'max' => '費用名は255文字以内で入力して下さい。(バックエンドから出力)',
        ],
        'category_id' => [
            'required' => 'カテゴリーを選択して下さい(バックエンドから出力)',
            'exists' => 'カテゴリーが存在しません(バックエンドから出力)',
        ],
        'income_date' => [
            'required' => '日付を入力して下さい。(バックエンドから出力)',
            'date' => '日付はYYYY-MM-DDの形式で入力して下さい。(バックエンドから出力)',
        ...
        'income_date_id' => [
            'required' => 'カテゴリーを入力して下さい。(バックエンドから出力)',
            'exists' => 'カテゴリーが存在しましせん。(バックエンドから出力)',
        ],
        'income_category_id' => [
            'required' => 'カテゴリーを選択して下さい。(バックエンドから出力)',
            'exists' => 'カテゴリーが存在しません(バックエンドから出力)',
